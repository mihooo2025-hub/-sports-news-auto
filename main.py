...
الأخبار التي يفشل التحقق من صفحة كووورة الخاصة بها
يتم حفظها أيضًا في قاعدة البيانات وإعادة محاولة التحقق
منها خلال نافذة الـ6 ساعات.
"""
...
def run_pipeline():
    ...
    if not news_items:
        ...
        print(
            "ℹ️ لم يتم العثور على أخبار جديدة أو "
