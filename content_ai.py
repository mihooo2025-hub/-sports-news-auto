...
- يجب تجنب الأخطاء الإملائية وأيضاً كتابة أسماء اللاعبين والمدربين بشكل صحيح بما يتداول عربياً.
...
- عند الانتقال بين التفاصيل يجب الانتقال بسلاسة مثل الذي يحكي قصة وذلك بوضع كلمات مناسبة مثل (و، وكما ذكرت ، وايضا وغيرها من الكلمات ) ويجب تجنب وضع الفواصل والنقاط (. ، ) داخل التفاصيل.
- يفضل عدم ذكر أسماء الصحف والمواقع في تفاصيل الخبر.

قواعد العنوان:
- اقترح عنوانًا واحدًا فقط، من 3 إلى 7 كلمات أو أكثر قليلاً.
- يجذب الانتباه وسريع، يخدم عنصر التشويق والفضول والغموض ، أو قد يأتي بصيغة سؤال ، يلمّح للحدث دون كشف كل التفاصيل.
...
• قرار نهائي لا رجعة فيه بشأن راشفورد..!
